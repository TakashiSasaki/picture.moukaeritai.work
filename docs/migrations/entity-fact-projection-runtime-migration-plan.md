...
- **Runtime Contract Evidence:** Rules, builder output, and runtime shadow writer alignment is gathered in the [Runtime Contract Evidence](scanner-observation-dual-write-runtime-contract-evidence.md) document before feature flag enablement.
